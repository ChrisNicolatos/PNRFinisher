...
Public Class GDSTicketItem
    'DocType: 1=ETKT 2= VCHR 3=Interoffice ticket
    ...
    Public ReadOnly Property Conjunction As String
        ...
        End Get
    End Property
    Friend Sub New(ByVal pGDSLine As String, ByVal pStockType As Integer, ByVal pDocument As Decimal, ByVal pBooks As Integer, ByVal pIssuingAirline As String, ByVal pAirlineCode As String, ByVal peTicket As Boolean, ByVal pSegs As String, ByVal pPax As String, ByVal pTicketType As String, ByVal pServicesDescription As String)
        GDSLine = pGDSLine
    ...
    End Sub
    Friend Sub New(ByVal RawText As String, ByVal DocType As EnumTicketDocType, ByVal PaxID As String, ByVal SegsElementNo As String) ', ByVal SegsDescription As String) ', ByVal ClassAir As String)
